...
/**
 * The station class represents a single mesonet station and its associated data
 * like location, temperature, humidity etc
 * 
...
public class Station {
	...
	// constructor
	public void setAllValues(String STID, String NAME, String ST, double LON, double LAT, int YEAR, int MO, int DA,
			int HR, int MI, double TAIR, double TDEW, double RELH, double CHIL, double HEAT, String WDIR, double WSPD,
			double WMAX, double PRES, double TMAX, double TMIN, double RAIN) {
	...
	public void populate() throws FileNotFoundException {
		...
		Scanner sc = new Scanner(new File(
				"C:\\Users\\Austin\\Documents\\GitHub\\DynamicWeatherInterpolatorSystem\\WebScrapePythonCode\\current.csv"));
		sc.useDelimiter(",");
